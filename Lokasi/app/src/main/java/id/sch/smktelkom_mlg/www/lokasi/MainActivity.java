package id.sch.smktelkom_mlg.www.lokasi;
...
public class MainActivity extends AppCompatActivity {
    private ImageButton buttonmaps;  private TextView Java;
 ...
 if (mapIntent.resolveActivity(getPackageManager()) != null) startActivity(mapIntent);
        ...
        intent.setData(Uri.parse("https://www.udacity.com/learn/java")); startActivity(intent);  }  });  }
